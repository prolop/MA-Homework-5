...
class Cell extends Component {
    render() {
        ...
        if (this.props.data.count > 0) {
            return (
                <div className="minesweeper__cell minesweeper__cell--open"
